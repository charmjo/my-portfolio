// Source for this component: https://tailwindcomponents.com/component/navbar-hamburger-menu
// I want ti structure it like this so that I can refactor it by parts later
    ...
    return (
        <div>
            <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-right lg:w-auto lg:space-x-6">
