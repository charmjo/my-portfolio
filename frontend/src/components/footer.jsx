                ...
                <div className=" grid grid-cols-1 gap-8 lg:grid-cols-3 items-center">
                    <div className="">
                        ...
                        <a href="">
                            ...
                            <p className="text-7xl font-sacramento"> charm relator </p>
                        </a>
                    </div>
                            ...
                            <nav className="text-azalea-900 items-center sm:w-fit mt-2 sm:mx-auto">
                                <a className="hover:opacity-75" href="https://www.linkedin.com/in/charm-johannes-relator/" target="_blank" rel="noreferrer" aria-hidden="true">
                                    ...
                                    <div className="flex flex-row justify-center sm:justify-start">
                                        ...
                                        <p className="ml-2 md:grow text-start">charm-johannes-relator</p>
                                    </div>
                                ...
                                <a className="hover:opacity-75" href target="_blank" rel="noreferrer">
                                    ...
                                    <div className="flex justify-center sm:justify-start mt-1">
                                        ...
                                        <p className="ml-2 md:grow text-start">charmjo</p> 
                                    </div>
                                </a>
                                {/* DO NOT DELETE AS I STILL NEED TO PUT EMAIL. */}
                                {/* <a className="hover:opacity-75" href target="_blank" rel="noreferrer">
                                    ...
                                    <div className="flex justify-center sm:justify-start mt-1">
                                        ...
                                        <p className="ml-2 md:grow text-start">test@test.com</p> 
                                    </div>
                                </a> */}
                                <a className="hover:opacity-75" href target="_blank" rel="noreferrer">
                                    ...
                                    <div className="flex justify-center sm:justify-start mt-1">
                                        ...
                                        <p className="ml-2 md:grow text-start">Waterloo, Ontario</p> 
                                    </div>
